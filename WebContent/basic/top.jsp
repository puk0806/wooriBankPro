	...
	<dd class="btn">
		<div class="js-display-hover btn-login">
			...
			<div class="js-display-hover-area select-banking-type">
				<a href="https://spib.wooribank.com/pib/Dream?withyou=CMLGN0001&target=https://spib.wooribank.com/pib/Dream?withyou=ps" class="on" >개인뱅킹</a>
				|
				<a href="https://sbiz.wooribank.com/biz/Dream?withyou=CMLGN0002&target=https://spib.wooribank.com/pib/Dream?withyou=ps" class="on" >기업뱅킹</a>
			</div>
...
$(function(){ $('.login-name1',$('.my-svc')).text( $('.login-name1',$('.my-svc')).text().cut(7) ); $(".login .fishing-img a.
-trigger").focus(function(){$(".js-display-hover-area.fishing-word-wrap").show();}); });	// 이름: 한글기준7자출력
...
<div id="lnb">
	...
	<ul class="level1 level1-ps">
			...
			<dd ><a  href="/pib/Dream?withyou=PSLON0371">서민형안심전환대출 전자약정</a></dd><dd ><a  href="/pib/Dream?withyou=PSLON0034">대상조회/인터넷약정체결</a></dd><dd ><a  href="/pib/Dream?withyou=PSLON0279">아낌-e 보금자리론 전자약정</a></dd>
			</dl></li>
...
<div id="util">
	...
	<span class="util-btn">
		...
		<a href="#"  title="새창열림" onclick='jsOpenWindow("Dream?withyou=CMDEM0005&amp;page=ps&amp;__STEP=1","demo",900,740,1,1);return false' class="btn-pack btn-type-1">체험하기</a>
