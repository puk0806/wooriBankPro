...
private static InsuranceDAO insuranceDao = null;
	...
	public List<InsuranceDTO> selectList(Connection conn,String user_id){
		String account_testno = "UI1000";		// 아이디 수정 요망
		String sql = "select account_no,account_number,account_yegeum_name "
					+"from account "
					+"where a_type_no='AT1008' and  u_info_no =  ?";
		...
		try {
			...
			System.out.println("insuranceDAO selectList예외 발생");
			e.printStackTrace();
		}finally {
				try {
