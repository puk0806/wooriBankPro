...
public class GoldDAO {
	...
	private static GoldDAO goldDao = null;
	...
	public List<GoldDTO> selectList(Connection conn,String user_id){
		...
		try {
			...
			System.out.println("goldDAO selectList예외 발생");
			e.printStackTrace();
		}finally {
				try {
