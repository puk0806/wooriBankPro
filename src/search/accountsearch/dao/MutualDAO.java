...
public class MutualDAO {
	...
	private static MutualDAO mutualDao = null;
	
	private MutualDAO() {}
	
	public static MutualDAO getInstance() { 
		if(mutualDao==null) {
	...
	public List<MutualDTO> selectList(Connection conn,String user_id){
		...
		ArrayList<MutualDTO> list = new ArrayList<MutualDTO>();
		...
		try {
			...
			System.out.println("mutualDAO selectList예외 발생");
			e.printStackTrace();
		}finally {
				try {
